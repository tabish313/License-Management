...
namespace License_Management
{
    class EmbedFont
    {
        ...
        public static void LoadRalewayFont()
        {
            ...
            string resource = "License_Management.Resources.Raleway-Regular.ttf";
        ...
        public static void LoadMicrossFont()
        {
            ...
            string resource = "License_Management.Resources.micross.ttf";
            // receive resource stream
            Stream fontStream = Assembly.GetExecutingAssembly().GetManifestResourceStream(resource);
        ...
        public static void LoadComfortaaFont()
        {
            ...
            string resource = "License_Management.Resources.Comfortaa-Regular.ttf";
            // receive resource stream
            Stream fontStream = Assembly.GetExecutingAssembly().GetManifestResourceStream(resource);
